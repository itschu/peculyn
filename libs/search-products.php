...
<section class="section products products-margin">
    <div class="products-layout container">
            ...
            <div class="bott" style="display: flex; align-items: center; justify-content: center; flex-direction: column; margin-bottom: 20px;">
                <ul class="pagination">
                    <span class="icon remFirst last">First</span>
                    <span class="last removePrev">Prev</span>
                    <span>1</span>
                    <span class="last removeNext">Next <!-- » --></span>
                    <span class="icon remLast last">Last</span>
                </ul>
                <span style="justify-self: flex-end"> <b><?php echo count($searchProducts) ?> Results Found</b> </span>
            </div>

            <?php 
                // if(count($searchProducts) == 0){ require_once('../libs/other-products.php'); }
            ?>
