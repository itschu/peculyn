...
<head>
    ...
    <title>Zimarex - Terms and Conditions | Ecommerce Webstore</title>
    <!-- fonts -->
...
<body>
    ...
    <section class="sections container" id="products">
        <div class="private">
            <div class="blended_grid">
                <div class="row1">
                    <span style="font-size: 34px;margin-top: -10px;">Our Terms and Conditions</span><br>
                    <div style="background: #ba0303; width: 100%; max-width: 1170px; height: 2px;"></div><br>
                </div>

                <div class="row1">
                    <div class="-heading">1. Introduction</div>
                    <div class="-content">
                    Ecart Internet Services Nigeria Limited ("Zimarex" or "we") operates an ecommerce platform consisting of a website and mobile application ("marketplace"), together with supporting logistics and payment infrastructure, for the sale and purchase of consumer products in Nigeria ("territory").<br>
                ...
                <div class="row1">
                    ...
                    <ol>
                        ...
                        <ul>
                            ...
                            <li>we shall accept binding sales, on behalf of sellers, but Zimarex is not a party to the transaction between the seller and the buyer; and</li>
                ...
                <div class="row1">
                    ...
                    <ol>
                        ...
                        <li>Returned products shall be accepted and refunds issued by Zimarex, for and on behalf of the seller.</li>
                ...
                <div class="row1">
                    ...
                    <div class="-content">
                    <ol>
                        <li>In this section 8 words "marketplace" and "website" shall be used interchangeably to refer to Zimarex’s websites and mobile applications.</li>
                        <li>
                        You may:
                        <ul>
                            <li>view pages from our website in a web browser;</li>
                            <li>download pages from our website for caching in a web browser;</li>
                            <li>print pages from our website for your own personal and noncommercial use, providing that such printing is not systematic or
                            excessive;</li>
                ...
                <div class="row1">
                    ...
                    <ol>
                        ...
                        <li>Zimarex’s logos and our other registered and unregistered trademarks are trademarks belonging to us; we give no permission for the use of these trademarks, and such use may constitute an infringement of our rights.</li>
                ...
                <div class="row1">
                    ...
                    <div class="-content">
                    <ol>
                        <li>Buyers agree to processing of their personal data in accordance with the terms of Zimarex’s Privacy and Cookie Notice</li>
                        <li>Zimarex shall process all personal data obtained through the marketplace and related services in accordance with the terms of our Privacy and Cookie Notice and Privacy Policy.</li>
                        <li>Sellers shall be directly responsible to buyers for any misuse of their personal data and Zimarex shall bear no liability to buyers in respect of any misuse by sellers of their personal data.</li>
                    </ol>
                    </div>
                </div>
                ...
                <div class="row1">
                    <div class="-heading">12. Zimarex’s role as a marketplace</div>
                    <div class="-content">
                    <ol>
                        <li>
                ...
                <div class="row1">
                    ...
                    <ol>
                        ...
                        <li>
                        If you breach these general terms and conditions, or if we reasonably suspect that you have breached these general terms and conditions or any Zimarex codes, policies or guidelines in any way we may:
                        <ul>
                ...
                <div class="row1">
                    ...
                    <div class="-content">
                    Should these general terms and conditions, the seller terms and conditions, and the Zimarex codes, policies and guidelines be in conflict, these terms and conditions, the seller terms and conditions and the Zimarex codes, policies and guidelines shall prevail in the order here stated.
                    </div>
                </div>
                ...
                <div class="row1">
                    ...
                    <ol>
                        ...
                        conditions, and the Zimarex codes, policies and guidelines from time to time.</li>
                ...
                <div class="row1">
                    ...
                    <div class="-content">
                    The marketplace is operated by Ecart Internet Services Nigeria Limited. We are registered in Nigeria under registration number RC 1034513, and our head office is at 109 Adeniyi Jones Street, Ikeja, Lagos. You can contact us by using our marketplace contact form
                    </div>
                </div>
                <br class="clear">
